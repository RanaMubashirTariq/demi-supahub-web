    ...
    <div className='CardsWithOutBorder'>
         <div className='CardsWithOutBorder-inner-d'>
               <div className='card-simple'>
                ...
                <div className='cards-para-d'><p className='cards-para-inner'>I love how simple Supahub makes it for our users and for admins to user feedback and changelog.</p></div>
               ...
               <div className='card-simple'>
                ...
                <div className='cards-para-d'><p className='cards-para-inner'>I dig this concept - Supahub helped us out a ton with prioritizing customer feedback!</p></div>
                <div className='card-rating-d'>
                  <p>⭐⭐⭐⭐⭐</p>
                  <p>Anant Dubey</p>
                </div>
